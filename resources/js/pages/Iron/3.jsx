            ...
            <div>
                <div className="wrapper">
                    <div className="block pt-6">
                        ...
                        <BiChevronRight className="inline-block mx-1" />
                        <p className="inline-block lowercase">{__("client.footer_metal_paper1", sharedData)}</p>
                    </div>
                    <div className="text-3xl my-10">{__("client.footer_metal_paper1", sharedData)}</div>
                </div>
                <div
