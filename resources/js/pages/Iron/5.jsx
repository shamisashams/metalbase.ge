...
const Iron1 = ({ seo, sizes, gphone, gemail, gaddress }) => {
            ...
            <div>
                <div className="wrapper">
                    <div className="block pt-6">
                        ...
                        <BiChevronRight className="inline-block mx-1" />
                        <p className="inline-block lowercase">{__("client.footer_metal_paper2", sharedData)}</p>
                    </div>
                    <div className="text-3xl my-10">{__("client.footer_metal_paper2", sharedData)}</div>
                </div>
                <div
                ...
                >
                    ...
                    <div className="wrapper">
                        <div className="max-w-lg lowercase text-justify relative z-20">
                            {renderHTML(__('client.metal_paper2_text', sharedData).replace(/(?:\r\n|\r|\n)/g, '<br>'))}
                        </div>
                        <select
                            name=""
                            id=""
